...
export class DropdownUIManager {
  ...
  static positionDropdown(dropdown, trigger) {
    try {
      ...
      DropdownUIManager.applyEmergencyPositioning(dropdown);
    }
  }
  ...
  static animateEntrance(dropdown, strategy = 'below') {
    ...
    dropdown.style.transform = DropdownUIManager.getEntryTransform(strategy);
    ...
    dropdown.addEventListener('keydown', e => {
      ...
      switch (e.key) {
        case 'ArrowDown':
          ...
          DropdownUIManager.updateSelection(options, currentIndex);
          break;
        case 'ArrowUp':
          e.preventDefault();
