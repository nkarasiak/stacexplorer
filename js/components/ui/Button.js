...
export class Button extends BaseUIComponent {
    ...
    updateButtonClasses() {
        ...
        // State classes
        if (this.state.isDisabled) classes.push(`${this.options.className}--disabled`);
        if (this.state.isLoading) classes.push(`${this.options.className}--loading`);
        if (this.state.isPressed) classes.push(`${this.options.className}--pressed`);
        if (this.state.isFocused) classes.push(`${this.options.className}--focused`);
        if (this.state.isHovered) classes.push(`${this.options.className}--hovered`);
        if (this.state.isActive) classes.push(`${this.options.className}--active`);
        
        // Option classes
        if (this.options.fullWidth) classes.push(`${this.options.className}--full-width`);
        if (this.options.rounded) classes.push(`${this.options.className}--rounded`);
        if (this.options.elevated) classes.push(`${this.options.className}--elevated`);
        if (this.options.compact) classes.push(`${this.options.className}--compact`);
        if (this.options.iconPosition === 'only') classes.push(`${this.options.className}--icon-only`);
