...
export class SearchHistoryUI {
  ...
  setupEventListeners() {
    ...
    document.addEventListener('click', e => {
      if (
        this.headerHistoryMenu &&
        !this.headerHistoryMenu.contains(e.target) &&
        this.headerHistoryBtn &&
        !this.headerHistoryBtn.contains(e.target)
      ) {
  ...
  updateHistoryList() {
    ...
    const historyHTML = recentSearches
      .map(search => {
