...
import { isGeoJSON, isWKT, parseGeoJSON, wktToGeoJSON } from '../../../utils/GeometryUtils.js';
...
export class LocationDropdown {
  ...
  async searchLocations(query, suggestionsContainer) {
    try {
      ...
      suggestionsContainer.innerHTML =
        '<div class="suggestion-error">Search failed. Please try again.</div>';
   ...
   */
  startDrawingBbox() {
    if (this.mapManager?.startDrawingBbox) {
